...
export const Banner = () => {
  return (
    <div data-aos="fade-up" style={bg} className='lg:mx-auto   bas md:mx-auto w-[300px] mx-auto bg-gradient-to-b from-blue-700 to-blue-800 py-6 my-[50px] poppin  lg:w-[1028px] bg-center bg-cover px-5 h-[300px] md:w-[628px]  md:px-6  rounded-md'>
