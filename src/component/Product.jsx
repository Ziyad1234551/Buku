...
export const Product = () => {
  ...
  return (
    <div data-aos="zoom-in" className='lg:w-[1328px] bas md:w-[728px] w-full px-3 mx-auto py-10'>
        ...
        <div className="flex lg:flex-row md:flex-row flex-col gap-4 my-4 justify-center">
            {books.map((book)=>{
                return(
                    <div className='bg-white mx-auto shadow-xl w-[250px] rounded-md  lg:w-[340px] md:w-[180px] py-6 px-6'>
