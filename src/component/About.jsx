...
export const About = () => {
  return (
    <div data-aos="fade-left" className='lg:w-[1328px] px-3 md:w-[728px] mx-auto flex-col lg:flex-row md:flex-row flex justify-between py-10 '>
